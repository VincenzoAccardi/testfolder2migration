...
Public Class TaArgenteaEMVRec : Inherits TPDotnet.Pos.TaBaseRec

#Region "Documentation"
    ' Tp.net Pos DataClass TaArgenteaEMVRec
    ' -----------------------------------
...
#Region "Properties"
    ...
    Public Overrides ReadOnly Property sId() As Short
        Get
            Return Italy_PosDef.TARecTypes.iTA_ARGENTEA_EMV
        End Get
    End Property
