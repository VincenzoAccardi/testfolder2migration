...
Public Class ModShortSignOff
    Inherits TPDotnet.Pos.ModShortSignOff
    Public Overrides Function ModBase_run(ByRef taobj As TPDotnet.Pos.TA, ByRef TheModCntr As TPDotnet.Pos.ModCntr) As Short
        ...
        LOG_Debug(getLocationString(funcName), "We are entered in Argentea Short Signoff overrride ModBase_run function")
        Try
